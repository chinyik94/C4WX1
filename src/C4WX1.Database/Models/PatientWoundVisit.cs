...
public partial class PatientWoundVisit
{
    ...
    public string WoundType { get; set; } = null!;
    ...
    public virtual Users? AssignedToID_FKNavigation { get; set; }
    ...
    public virtual PatientWound PatientWoundID_FKNavigation { get; set; } = null!;
