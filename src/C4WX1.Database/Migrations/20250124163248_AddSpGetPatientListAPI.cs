...
{
    /// <inheritdoc />
    public partial class AddSpGetPatientListAPI : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                CREATE OR REPLACE FUNCTION "fn_spGetPatientListAPI"(
                ...
                BEGIN
                	IF EXISTS (
                	    ...
                	    SELECT 
                	        ...
                	        pf."Note",
                	        p."NursingStation",
                			pf1."FacilityID_FK" AS "FacilityID"
                	    FROM "Patient" p
                		...
                		LEFT JOIN "PatientFacility" pf1 ON pf1."PatientID_FK" = p."PatientID"
        ...
        {
            migrationBuilder.Sql("""
                DROP FUNCTION IF EXISTS "fn_spGetPatientListAPI";
                """);
        }
    }
}
